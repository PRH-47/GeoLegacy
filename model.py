...
class wellload:
    def __init__(self, path):
        ...
        self.AGP_OPT = Open_Service._Tuples(
            Search_Path.Search_Files(path, ("agp")))
    ...
    def Merge_dict(self,):
        ...
        zip_iter = list(zip(self.Head_list.HEADPOOL.__iter__(),
                        self.unid.POCO_SESSION_DICT.__iter__()))
